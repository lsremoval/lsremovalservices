...
export const metadata: Metadata = {
  title: "About Us",
  description:
    "L&S Removal Services is a locally owned junk removal company founded by Caleb and Jeremy, based in Taylorsville, NC, serving the corridor to Charlotte.",
